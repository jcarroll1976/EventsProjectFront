...
export function deleteUserFavorite(id: string, event: Event):Promise<UserFavorites>{
    return axios.delete("https://us-central1-final-project-event-app.cloudfunctions.net/api/favorites/"+id, event)
    .then(response=>response.data)
}
